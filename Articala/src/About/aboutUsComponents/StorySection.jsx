                    ...
                    <Row>
                        <Col lg={6}>
                            <div className="d-flex flex-wrap">
                                ...
                                <div ref={expandingBall}  className="expandingBall d-flex flex-column gap-3">
                                    <p className='DisplayMid textWhite'>We’ve been here <br /> almost 15 years</p>
